var X=Object.defineProperty;var $=(b,e,t)=>e in b?X(b,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):b[e]=t;var h=(b,e,t)=>$(b,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();class P{constructor(){this.state="created",this.host=null,this.bindings=[],this.views=[],this.animations=[],this.animationQueue=[],this.destroyed="",this.moved=""}static create(e,t={},i,n={parent:null,prepare:!0,sibling:null}){const s=new P;if(s.model=t,s.element=i??e,s.parent=n.parent??u,s.host=n.host??s.parent.host,s.sibling=n.sibling??null,i instanceof HTMLTemplateElement||(i==null?void 0:i.tagName)==="TEMPLATE"){const r=i.content.cloneNode(!0);if(r.children.length===1)return u.create(e,t,r.firstElementChild,n);s.views=[...r.children].map(a=>u.create(e,t,a,{...n,parent:s})),s.state="rendered"}else s.bindings.push(...u.parse(s.element,t,s,n.parent));return s.parentElement=i!=null?e:e.ownerDocument.documentElement,s.views.length>1?(s.attached=Promise.all(s.views.map(r=>r.attached)),s.detached=Promise.all(s.views.map(r=>r.detached))):(s.attached=new Promise(r=>{s.t=r}),s.detached=new Promise(r=>{s.i=r})),s}get lastElement(){var i,n;if(this.render==null&&(this.render=!(((n=(i=this.element).hasAttribute)==null?void 0:n.call(i,"PUI-UNRENDERED"))??!1)),this.render)return this.element;const t=this.bindings.flatMap(s=>s.views).slice(-1)[0];return t==null?void 0:t.lastElement}destroy(){var e;this.views.forEach(t=>t.destroy()),(e=this.element.classList)==null||e.add("pui-removing"),this.destroyed="queue",u.destroyed.push(this)}terminate(){Promise.all(this.getAnimations()).then(()=>{var i;const e=this.element.parentElement;e==null||e.removeChild(this.element),(i=this.i)==null||i.call(this),this.dispatchEvent(e,"removed"),this.bindings.forEach(n=>n.unbind());const t=this.parent.views.findIndex(n=>n===this);t>-1&&this.parent.views.splice(t,1)}),this.destroyed="destroyed"}move(e){var t;this.moved="queue",(t=this.element.classList)==null||t.add("pui-moving"),this.sibling=e}play(e,t){return typeof e=="string"&&(e=this.animations.find(i=>i.name===e).clone()),e.element=t,e.state="pending",this.animationQueue.push(e),this.updateAnimations(performance.now()),e}updateFromUI(){this.views.forEach(e=>e.updateFromUI()),this.bindings.forEach(e=>e.updateFromUI())}updateToUI(){var t,i,n,s,r;const e=this.state==="created";switch(e||(this.views.forEach(a=>a.updateToUI()),this.bindings.forEach(a=>a.updateToUI())),this.state){case"created":if((t=this.element.classList)==null||t.add("pui-adding"),this.render=!(((n=(i=this.element).hasAttribute)==null?void 0:n.call(i,"PUI-UNRENDERED"))??!1),this.render){const a=(s=this.parent)==null?void 0:s.parent;let o=((a==null?void 0:a.render)??!1?this.sibling:a==null?void 0:a.sibling)??null;o=(o instanceof P?o.lastElement:o)??null;const d=this.parentElement??u.parentElement(this.element,this.parent);d.insertBefore(this.element,(o==null?void 0:o.nextSibling)??null),this.dispatchEvent(d,"added")}this.t(),this.state="attaching";break;case"attaching":this.getAnimations(!1).length===0&&((r=this.element.classList)==null||r.remove("pui-adding"),this.state="attached");break;case"attached":this.state="rendered";break}e&&(this.views.forEach(a=>a.updateToUI()),this.bindings.forEach(a=>a.updateToUI()))}updateAtEvents(){this.views.forEach(e=>e.updateAtEvents()),this.bindings.forEach(e=>e.updateAtEvents())}updateAnimations(e){var t;for(;((t=this.animationQueue[0])==null?void 0:t.state)==="finished";)this.animationQueue.shift().destroy();for(let i=0;i<this.animationQueue.length;i++){const n=this.animationQueue[i];n.state==="pending"&&(n.isBlocked(e)||(n.state="playing",n.startTime=e,n.animation=n.element.animate(n.keyframes,n.options),n.finished=n.animation.finished,n.finished.then(()=>{n.state="finished",this.updateAnimations(performance.now())})))}}updateMove(){var e;switch(this.moved){case"queue":this.moved="move";break;case"move":if(this.getAnimations().length===0){const t=this.parentElement??u.parentElement(this.element,this.parent);let i=(this.sibling instanceof P?this.sibling.lastElement:this.sibling)??null;if(this.render)t.insertBefore(this.element,(i==null?void 0:i.nextSibling)??null);else{const n=this.bindings.flatMap(s=>s.views);for(const s of n)t.insertBefore(s.element,(i==null?void 0:i.nextSibling)??null),i=s.element}(e=this.element.classList)==null||e.remove("pui-moving"),this.moved="",this.sibling=null}break}this.bindings.forEach(t=>t.updateMove()),this.views.forEach(t=>t.updateMove())}getAnimations(e=!0){var t,i;return(((i=(t=this.element).getAnimations)==null?void 0:i.call(t,{subtree:e}))??[]).filter(n=>{var s;return n.playState!=="finished"&&((s=n.effect)==null?void 0:s.getTiming().iterations)!==1/0}).map(n=>n.finished)}dispatchEvent(e,t){if(e!=null){const i=new CustomEvent(`pui-${t}`,{detail:{model:this.model.$model??this.model,context:this.model,element:this.element,view:this},bubbles:!0,cancelable:!0});e.dispatchEvent(i)}}}class V{constructor(){this.fromUI=!1,this.toUI=!0,this.atEvent=!1,this.oneTime=!1,this.views=[],this.firstUpdate=!0,this.events=[],this.triggerAtEvent=e=>{e.type==="change"?this.events.push(e):u.resolveValue(this.object,this.property).call(this.object.$model,e,this.object.$model,this.element,this.attribute,this.object)},this.twoWayBindingEvent=e=>{const{target:t,property:i}=u.resolveProperty(this.object,this.property),n=e.detail;if(n!==this.lastUIValue){let s=n;s!==void 0&&s!==this.lastValue&&u.resolveValue(this.object,this.property)==="number"&&!isNaN(s)&&(s=+s),t[i]=s}},this.id=++u.id}get element(){return this.$element==null&&(this.$element=typeof this.selector=="string"?this.context.querySelector(this.selector):this.selector),this.$element}set element(e){this.$element=e}static create(e){var a,c,o;const t=new V,i=((a=e.property)==null?void 0:a.split(":"))??[],n=i.shift(),s=typeof e.attribute!="boolean"?(e.attribute??"innerText").split(":"):[],r=typeof e.attribute!="boolean"?s.shift():e.attribute;if(t.parent=e.parent??u,t.object="$model"in e.object?e.object:{$model:e.object},t.object.$parent==null){const d=(o=(c=t.parent.parent)==null?void 0:c.object)==null?void 0:o.$parent;d!=null&&(t.object.$parent=d)}return t.property=n,t.propertyArguments=i,t.context=e.context??document,t.selector=e.selector,t.attribute=r,t.attributeArguments=s,t.value=e.value??t.value,t.template=e.template??t.template,t.fromUI=e.fromUI??t.fromUI,t.toUI=e.toUI??t.toUI,t.atEvent=e.atEvent??t.atEvent,t.oneTime=e.oneTime??t.oneTime,t.addListener(),typeof t.fromUI!="boolean"&&(t.fromUI=t.fromUI.bind(t)),typeof t.toUI!="boolean"&&(t.toUI=t.toUI.bind(t)),t}destroy(){this.element=null,this.removeListener(),this.views.forEach(e=>e.destroy())}unbind(){u.unbind(this)}addListener(){this.atEvent&&(this.toUI=!1,this.fromUI=!1,this.element.addEventListener(this.attribute,this.triggerAtEvent)),this.toUI&&this.fromUI&&customElements.get(this.element.tagName.toLowerCase())!=null&&this.element.addEventListener(this.attribute,this.twoWayBindingEvent)}removeListener(){this.atEvent&&this.element.removeEventListener(this.attribute,this.triggerAtEvent),this.toUI&&this.fromUI&&customElements.get(this.element.tagName.toLowerCase())!=null&&this.element.removeEventListener(this.attribute,this.twoWayBindingEvent)}updateFromUI(){var n;if(this.fromUI===!1||this.firstUpdate){this.firstUpdate=!1,this.views.forEach(s=>s.updateFromUI());return}const{target:e,property:t}=u.resolveProperty(this.element,this.attribute),i=e[t];if(i!==this.lastUIValue){let s=this.fromUI!==!0?this.fromUI(i,this.lastUIValue,this.property,this.object):i;if(this.lastUIValue=i,s!==void 0&&s!==this.lastValue){this.lastValue=s;const{target:r,property:a}=u.resolveProperty(this.object,this.property);u.resolveValue(this.object,this.property)==="number"&&!isNaN(s)&&(s=+s),r[a]=s}else this.lastValue=s;(n=this.parent.host)==null||n.dispatchEvent(new CustomEvent(t,{detail:s}))}this.views.forEach(s=>s.updateFromUI())}updateToUI(){if(this.toUI===!1){this.views.forEach(t=>t.updateToUI());return}let e=u.resolveValue(this.object,this.property);if(this.template!=null)if(this.template instanceof HTMLElement)if(typeof this.attribute=="boolean"){if(e=(e??!1)!==!1,e!==this.lastValue){const t=this.toUI!==!0?this.toUI(e,this.lastValue,this.property,this.object,this.value):e;if(t!==void 0&&t!==this.lastUIValue){if(t===this.attribute)this.views.push(P.create(this.element.parentElement,this.object,this.template.cloneNode(!0),{parent:this,prepare:!1,sibling:this.element}));else{const i=this.views.pop();i==null||i.destroy()}this.lastValue=e,this.lastUIValue=t}}}else{let t=!1,i=!1;e==null&&(e=[]);const n=this.propertyArguments[0],s=this.lastValue??[];if(e.length!==s.length)t=!0;else for(let l=0,k=e.length;l<k;l++){let v,m;n==null?e[l]!==s[l]&&(t=!0,i=!0):(v=u.resolveValue(e[l]??{},n),m=u.resolveValue(s[l]??{},n),v!==m&&(t=!0),e[l]!==s[l]&&(i=!0))}if(!t)if(i){const l=this.toUI!==!0?this.toUI(e,s,this.property,this.object,this.value):e;return this.updateViews(e,l)}else return this.updateViews();const r=this.toUI!==!0?this.toUI(e,s,this.property,this.object,this.value):e;if(r==null)return this.updateViews();const a=this.lastUIValue??[];let c=0;for(let l=0,k=r.length,v=0;l<k;l++,v++){let m,p;if(n==null?(m=r[l],p=a[v]):(m=u.resolveValue(r[l]??{},n),p=u.resolveValue(a[v]??{},n)),m===p)c++;else break}if(c===r.length&&r.length===a.length)return this.updateViews(e,r);const o=this.views.splice(0,c);let d=o[o.length-1];for(let l=c,k=r.length,v=c;l<k;l++,v++){const m=r[l],p=this.views.shift();if(p==null){const g={$model:{[this.attribute]:m},$parent:this.object},I=P.create(this.element.parentElement,g,this.template.cloneNode(!0),{parent:this,prepare:!1,sibling:d??this.element});o.push(I),d=I;continue}const w=n==null?m:u.resolveValue(m??{},n),f=p==null?void 0:p.model.$model[this.attribute],y=n==null?f:u.resolveValue(f??{},n);if(w===y){o.push(p),p.move(d??this.element),d=p;continue}if(!r.slice(l).map(g=>n==null?g:u.resolveValue(g??{},n)).includes(y)){p.destroy(),l--,d=p;continue}this.views.unshift(p);let j=!1;for(let g=0,I=this.views.length;g<I;g++){const U=this.views[g],C=U==null?void 0:U.model.$model[this.attribute],E=n==null?C:u.resolveValue(C??{},n);if(w===E){o.push(...this.views.splice(g,1)),U.move(d??this.element),j=!0,d=U;break}}if(!j){const g={$model:{[this.attribute]:m},$parent:this.object},I=P.create(this.element.parentElement,g,this.template.cloneNode(!0),{parent:this,prepare:!1,sibling:d??this.element});o.push(I),d=I}}return this.views.forEach(l=>l.destroy()),this.views=o,this.updateViews(e,r)}else{const t=u.resolveValue(this.object,this.attribute);if((e??t)==null||(e??t)!==this.lastValue){this.lastUIValue!=null&&(this.lastUIValue.destroy(),this.lastUIValue=null);const i=e==null?t:t.create(e),n=t.template;this.lastValue=e??t;const s=this.element.nodeType===8?this.element.parentElement:this.element,r=this.element.nodeType===8?this.element:null;if(this.lastUIValue=u.create(s,i,n,{parent:this,prepare:!0,sibling:r}),this.attributeArguments[0]!=null&&e!=null){const{target:a,property:c}=u.resolveProperty(this.object,this.attributeArguments[0]);a[c]=this.lastUIValue}this.views.push(this.lastUIValue)}}else if(e!==this.lastValue){const t=this.toUI!==!0?this.toUI(e,this.lastValue,this.property,this.object,this.value):e;if(t!==void 0&&t!==this.lastUIValue){const{target:i,property:n}=u.resolveProperty(this.element,this.attribute);i[n]=t,"setAttribute"in this.element&&this.element.setAttribute(this.attribute,t),this.lastValue=e,this.lastUIValue=t}}this.updateViews()}updateAtEvents(){let e=this.events.shift();for(;e!=null;)u.resolveValue(this.object,this.property).call(this.object.$model,e,this.object.$model,this.element,this.attribute,this.object),e=this.events.shift();this.views.forEach(t=>t.updateAtEvents())}updateMove(){this.views.forEach(e=>e.updateMove())}updateViews(e,t){e==null?this.views.forEach(i=>i.updateToUI()):(this.views.forEach((i,n)=>{const s=t[n];typeof s=="object"&&(s.$index=n),i.model.$model[this.attribute]=s,i.model.$index=n,i.updateToUI()}),this.lastValue=[...e],this.lastUIValue=[...t]),this.oneTime&&(this.toUI=!1,this.fromUI=!1)}}var L;class A{static initialize(e=!0){if(!this.initialized&&(this.initialized=!0,this.initializeLoadPromise(),e!==!1)){if(e===!0){const t=()=>{this.update(),requestAnimationFrame(t)};requestAnimationFrame(t);return}setInterval(()=>this.update(),1e3/e)}}static import(e){this.initializeLoadPromise(),document.body.insertAdjacentHTML("afterbegin",`<object type="text/pui" data="${e}"></object>`)}static ready(){return this.initialize(),this.loadPromise.then(()=>(this.hoist()&&document.head.insertAdjacentHTML("beforeend",'<style> object[type="text/pui"] { height: 0; position: absolute; } </style>'),this.registrations))}static create(e=document.body,t={},i=null,n={parent:null,prepare:!0,sibling:null}){var r;if(typeof e=="string"&&(e=document.querySelector(e)),(typeof t=="string"||t instanceof HTMLElement)&&(console.warn("Old parameter order to UI.create!"),[t,i]=[i,t]),typeof i=="string"){const a=((r=e==null?void 0:e.ownerDocument)==null?void 0:r.defaultView)!=null?e.ownerDocument:document;if(i.startsWith("#"))i=a.querySelector(i).cloneNode(!0);else{const c=a.createElement("template");c.innerHTML=n.prepare?this.prepare(i):i,i=c}}const s=P.create(e,t,i,n);return s.parent===u&&this.views.push(s),this.initialize(),s}static play(e,t){return typeof e=="string"?(e=this.globals.animations.find(i=>i.name===e).clone(),e.play(t)):e.play()}static queue(e){this.h.push(e),this.initialize()}static register(e,t){if(typeof e=="string"){this.registrations[e]=t;return}this.registerWebComponent(t,e)}static parse(e,t,i,n){const s=[];if(e instanceof Comment)return[];if(e instanceof HTMLTemplateElement||e.tagName==="TEMPLATE")return[];if(e.nodeType===3){let r=e.textContent,a=r.match(this.regexValue);for(;a!=null;){const c=a[1];let o=a[2];r=a[3];let d=!1;o.startsWith("|")&&(d=!0,o=o.slice(1).trimStart());const l=o.match(this.regexConditionalValue);let k,v=!0;if(o.startsWith("(")){const p=`_pui${this.bindingCounter++}`;Object.defineProperty(t,p,{get:new Function(`return ${o}`)}),o=p}else l&&(o=l[3],k=`${l[2]}${l[1]}`,v=function(p,w,f,y,j){const g=j[0]==="=";return j=j.slice(2,-1),!!p===g?j:""});let m=e.cloneNode();e.textContent=c,this.parentElement(e,n).insertBefore(m,e.nextSibling),s.push(this.bind({selector:m,attribute:"textContent",object:t,property:o,parent:i,oneTime:d,value:k,toUI:v})),e=m,m=e.cloneNode(),m.textContent=r,this.parentElement(e,n).insertBefore(m,e.nextSibling),e=m,a=r.match(this.regexValue)}}else{const r=e.getAttribute("pui")??"";if(r.trim().length>0){const a=r.split(";");for(let c of a)c=c.trim(),c.length>0&&e.setAttribute(`pui.${this.bindingCounter++}`,c)}if(e.removeAttribute("pui"),s.push(...Object.keys(e.attributes??[]).reverse().map(a=>{var v;const c=[];if(e instanceof Comment)return[];const o=e.attributes[a];if(o.name.startsWith("pui.")){const m=o.value.match(this.regexAttribute);let[p,w,f,y,j]=m,g,I,U=!1;if(f!=="@"){const C=w.match(/^'(.*?)'$/);if(C!=null)g=C[1],e.setAttribute("value",g),w=e.nodeName.toLowerCase()==="option"?"selected":"checked",y=E=>E?g:void 0,f=E=>E===g;else if(w==="")if(y===">"){const[E,H]=j.split(":");if(E.length>0){const{target:x,property:M}=this.resolveProperty(t,E);x[M]=e}return(H??"").length>0&&u.queue(()=>{const{target:x,property:M}=this.resolveProperty(t,H);x[M]=i}),[]}else({element:e,template:I}=this.replaceWithComment(e,i,n,o.name)),w=f==="=",f=!0,y==="|"&&(U=!0);else if(y==="="&&f==="="){if(!e.tagName.includes("-")){e.setAttribute("pui-unrendered","");const E=this.parentNode(e,n);E.nodeType!==8?{element:e,template:I}=this.replaceWithComment(e,i,n,o.name,I):e=E}I=w,f=!0}else y==="*"?{element:e,template:I}=this.replaceWithComment(e,i,n,o.name):y==="|"?U=!0:w!=="checked"&&e.setAttribute(w,((v=e.getAttribute)==null?void 0:v.call(e,w))??"")}return[this.bind({selector:e,attribute:w,value:g,object:t,property:j,template:I,toUI:typeof f=="string"?f==="<":f,fromUI:typeof y=="string"?y===">":y,atEvent:f==="@",parent:i,oneTime:U})]}const d=[o.value];let l=0,k=d[l].match(this.regexValue);for(;k!=null;){let{before:m,property:p,after:w}=k.groups,f=!1;p.startsWith("|")&&(f=!0,p=p.slice(1).trimStart());const y=p.match(this.regexConditionalValue);let j;y&&(p=y[3],j=`${y[2]}${y[1]}`),c.push(this.bind({selector:e,attribute:o.name,object:t,property:p,oneTime:f,toUI(g,I,U,C,E){if(this.oneTime){const x=d.indexOf(U);x>-1&&(d[x]=u.resolveValue(C,U),d[x-1]+=d[x]+d[x+1],d.splice(x,2))}const H=d.map((x,M)=>{if(M%2===0)return x;const T=x.match(u.regexSplitConditionalValue);if(T){const D=x===`${U}${E}`?g:u.resolveValue(C,T[1]),z=T[2]==="=";return!!D===z?T[3].slice(1,-1):""}return x===U?g:u.resolveValue(C,x)}).join("");return e.setAttribute(o.name,H),H},parent:i,value:j})),d[l++]=m,d[l++]=`${p}${j??""}`,d[l]=w,k=d[l].match(this.regexValue)}return c}).flat()),e instanceof Comment)return s.filter(a=>a.template!=null?!0:(a.unbind(),!1));if(!this.leaveAttributes)for(let a=Object.keys(e.attributes??[]).length-1;a>=0;a--){const c=e.attributes[Object.keys(e.attributes??[])[a]];c.name.startsWith("pui.")&&e.removeAttribute(c.name)}s.push(...Array.from(e.childNodes).map(a=>this.parse(a,t,i,n)).flat())}return s}static bind(e){return V.create(e)}static unbind(e){if(e.destroy(),e.parent!==u){const t=e.parent.bindings,i=t.indexOf(e);i>-1&&t.splice(i,1)}}static update(){this.u.forEach(t=>t()),this.u=this.h,this.h=[],this.views.forEach(t=>t.updateToUI()),this.views.forEach(t=>t.updateFromUI()),this.views.forEach(t=>t.updateAtEvents());const e=performance.now();[...this.views,this.globals].forEach(t=>t.updateAnimations(e)),this.views.forEach(t=>{t.updateMove()});for(let t=0;t<this.destroyed.length;t++){const i=this.destroyed[t];switch(i.destroyed){case"queue":i.state==="rendered"?i.destroyed="destroy":i.updateToUI();break;case"destroy":{i.terminate();const n=this.destroyed.findIndex(s=>i===s);n>-1&&(this.destroyed.splice(n,1),t--)}}}}static resolveProperty(e,t){t=t.replace("[",".").replace("]",".");const i=t.split(".").filter(s=>(s??"").length>0);for(;i[0]==="$parent"&&e.$parent!=null;)e=e.$parent,i.shift();let n=e;if(i[0]==="$index"&&this.objectHas(n,"$index"))return{target:n,property:i[0]};for(this.objectHas(n,"$model")&&(n=e.$model);i.length>1;)n=n[i.shift()];return{target:n,property:i[0]}}static resolveValue(e,t){let i=0;do{const{target:n,property:s}=this.resolveProperty(e,t);if(n!=null&&this.objectHas(n,s))return n[s];e=e.$parent}while(e!=null&&i++<1e3);if(t in this.registrations)return this.registrations[t]}static initializeLoadPromise(){var e;this.loadPromise==null&&(this.loadPromise=new Promise(t=>this.loadResolve=t),(e=document.defaultView)==null||e.addEventListener("load",this.loaded))}static hoist(e=document,t=document){e!==t&&((t.querySelectorAll("style")??[]).forEach(s=>{e.head.appendChild(s.cloneNode(!0))}),(t.querySelectorAll("template")??[]).forEach(s=>{e.head.appendChild(s.cloneNode(!0))}));const i=t.querySelectorAll('object[type="text/pui"]')??[];let n=i.length>0;return i.forEach(s=>{n=this.hoist(e,s.contentDocument)||n}),n}static objectHas(e,t){try{return t in e}catch{return!1}}static replaceWithComment(e,t,i,n,s){const r=document.createComment(n);return this.parentNode(e,i).insertBefore(r,e),this.parentNode(e,i).removeChild(e),e.removeAttribute(n),s=s??e,e=r,e.parentNode instanceof DocumentFragment&&(t.element=e),{element:e,template:s}}static parentElement(e,t){const i=e.parentElement;if(i!=null)return i;for(;t!=null&&(t.element==null||t.element===e);)t=t.parent;return t==null?void 0:t.element}static parentNode(e,t){const i=e.parentNode;if(i!=null)return i;for(;t!=null&&(t.element==null||t.element===e);)t=t.parent;return t==null?void 0:t.element}static prepare(e){let t=e;e="";let i=t.match(this.regexReplace);for(;i!=null;){const[n,s,r,a]=i;r.match(/\S\s*===/)?e+=`${s.trimEnd()}br PUI.${this.bindingCounter++}="${r}"`:e+=`${s} PUI.${this.bindingCounter++}="${r}" `,t=a,i=t.match(this.regexReplace)}return e+=t,e}static parseAttribute(e,t,i,n,s,r){const a=r.match(this.regexAttribute);let[c,o,d,l,k]=a,v,m,p=!1;if(d!=="@"){const w=o.match(/^'(.*?)'$/);if(w!=null)v=w[1],e.setAttribute("value",v),o=e.nodeName.toLowerCase()==="option"?"selected":"checked",l=f=>f?v:void 0,d=f=>f===v;else if(o==="")if(l===">"){const{target:f,property:y}=this.resolveProperty(t,k);return f[y]=e,[]}else({element:e,template:m}=this.replaceWithComment(e,i,n,s)),o=d==="=",d=!0,l==="|"&&(p=!0);else if(l==="="&&d==="="){const f=this.parentNode(e,n);f.nodeType!==8?{element:e,template:m}=this.replaceWithComment(e,i,n,s,m):e=f,m=o,p=!0,d=!0}else l==="*"?{element:e,template:m}=this.replaceWithComment(e,i,n,s):l==="|"?p=!0:o!=="checked"&&e.setAttribute(o,"")}return[this.bind({selector:e,attribute:o,value:v,object:t,property:k,template:m,toUI:typeof d=="string"?d==="<":d,fromUI:typeof l=="string"?l===">":l,atEvent:d==="@",parent:i,oneTime:p})]}static registerWebComponent(e,t){e??(e=t.webComponent);class i extends HTMLElement{constructor(){super(),this.webComponentComponent=t,this.webComponentUIView=null,this.attachShadow({mode:"open"})}connectedCallback(){this.initialize()}disconnectedCallback(){this.terminate()}attributeChangedCallback(r,a,c){this.initialize(),this.webComponentUIView.model[r]=c}initialize(){var r;if(this.webComponentUIView==null){const a="create"in this.webComponentComponent?this.webComponentComponent.create():new this.webComponentComponent;a.webComponentHost=this,this.webComponentUIView=u.create(this.shadowRoot,a,this.webComponentComponent.template,{host:(r=this.shadowRoot)==null?void 0:r.host})}}terminate(){this.webComponentUIView!=null&&this.webComponentUIView.destroy()}}i.observedAttributes=t.observedAttributes??[],i.observedProperties=t.observedProperties??i.observedAttributes;const n=[...new Set([...i.observedAttributes,...i.observedProperties])];for(const s of n)Object.defineProperty(i.prototype,s,{configurable:!0,enumerable:!1,get(){return this.webComponentUIView.model[s]},set(r){i.observedAttributes.includes(s)?this.setAttribute(s,r):(this.initialize(),this.webComponentUIView.model[s]=r)}});return customElements.define(e,i),i}}L=A;A.initialized=!1;A.id=0;A.views=[];A.destroyed=[];A.globals=new P;A.registrations={};A.leaveAttributes=!1;A.regexReplace=/([\S\s]*?)\\?\$\{([^}]*?[<=@!]=[*=>|][^}]*?)\}([\S\s]*)/m;A.regexAttribute=/^\s*(\S*?)\s*([<=@!])=([*=>|])\s*(\S*?)\s*$/;A.regexValue=/(?<before>[\S\s]*?)\\?\$\{\s*(?<property>[\s\S]*?)\s*\}(?<after>[\S\s]*)/m;A.regexConditionalValue=/^\s*(.+?)\s*([=!])\s*(\S+)/;A.regexSplitConditionalValue=/^(.+?)([=!])(.*)/;A.bindingCounter=0;A.u=[];A.h=[];A.loaded=()=>{var b;L.loadResolve(),(b=document.defaultView)==null||b.removeEventListener("load",L.loaded)};function N(){let b=window,e=window;for(;;)try{if(b.parent===b){e=b;break}else b.parent.UI!=="guarantee-condition-always-true"&&(b=b.parent)}catch{break}return e}const S=N();"UI"in S||(S.UI=A);const u=S.UI;class Y{constructor(){h(this,"template",`
    <style>
        .nav-wrapper {
    ...
    `)}}class ue{constructor(){h(this,"current","home");h(this,"homepage",new Q);h(this,"aboutme",new W);h(this,"peasy",new G);h(this,"bindings",new J);h(this,"eventpage",new _);h(this,"csspage",new te);h(this,"arraypage",new se);h(this,"animations",new oe);h(this,"components",new de);h(this,"template",`
  <style>
    .router {
      position: fixed;
      width: 80%;
  ...
  </div>`)}changeRoute(e){this.current="blank",setTimeout(()=>{this.current=e},250)}get showHome(){return this.current=="home"}get showPeasy(){return this.current=="peasy"}get showBindings(){return this.current=="bindings"}get showEvents(){return this.current=="events"}get showCSS(){return this.current=="css"}get showArray(){return this.current=="array"}get showAnimations(){return this.current=="animations"}get showComponents(){return this.current=="components"}get showAbout(){return this.current=="about"}get showBlank(){return this.current=="blank"}get showArrayPage(){return this.current=="array"}}let O=new Y,R=new Z,B=new ue;const pe={navbar:O,header:R,router:B},ce=`
<style>
    html {
      margin: 0;
      padding: 0;
